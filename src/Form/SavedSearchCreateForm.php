  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    if ($return === SAVED_NEW) {
      ...
      if ($search->get('notify_interval')->value < 0) {
        drupal_set_message($this->t('Your saved search was successfully created.'), 'status');
      }
      else {
        drupal_set_message($this->t('Your saved search was successfully created. You will receive notifications for new results in the future.'), 'status');
      }
    }
